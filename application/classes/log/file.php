...
/**
 * Custom File log writer based on the default Kohana Log Writer. Writes out messages and stores them in a YYYY/MM/DD/Projectname directory.
 *
 * @package    Kohana
 * @category   Logging
 */
class Log_File extends Log_Writer {
	 ...
	 * appended to the `YYYY/MM/DD/Projectname.log.php` file, where YYYY is the current
	...
	public function write(array $messages)
	{
		...
		// Set the name of the log file using the project name
		if (defined('PROJECTNAME'))
		{
			$filename = $directory.DIRECTORY_SEPARATOR.PROJECTNAME.EXT;
		}

		// If the project is unknown use unknown
		else
		{
			$filename = $directory.DIRECTORY_SEPARATOR.'unknown'.EXT;
		}
		...
		{
			$message['body'] = ibhelpers::clear_cc($message['body']);
