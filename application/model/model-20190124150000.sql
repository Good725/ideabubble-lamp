...
/* Add the '45' (Run for Liam) theme, if it does not already exist */
DELIMITER  ;;
INSERT INTO
  `engine_site_themes` (`title`, `stub`, `template_id`, `date_created`, `date_modified`)
  SELECT '45', '45', (SELECT `id`  FROM `engine_site_templates` WHERE `stub` = '04' LIMIT 1), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
    FROM `engine_site_themes`
    WHERE NOT EXISTS (SELECT * FROM `engine_site_themes` WHERE `stub` = '45')
    LIMIT 1
;;


/* Add the '45' theme styles */
UPDATE
  `engine_site_themes`
SET
...
\n
\n:root {
\n    \-\-primary: #52c5fa;   \-\-primary-hover: #6bcdfa;   \-\-primary-active: #39bcf9;
\n    \-\-secondary: #f5f5f5; \-\-secondary-hover: #d3d3d3; \-\-secondary-active: #e6e6e6;
\n    \-\-success: #762c95;   \-\-success-hover: #9538bc;   \-\-success-active: #57216e;
...
\n
\n.select:after {
\n    border-top-color: #762c95;
\n}
\n
\n.form-select:before {
\n    background-image: -webkit-linear-gradient(left, transparent 0, transparent calc(100% - 2.75em), #762c95 calc(100% - 2.75em), #762c95 100%);
\n    background-image: linear-gradient(to right, transparent 0, transparent calc(100% - 2.75em), #762c95 calc(100% - 2.75em), #762c95 100%);
\n}
\n
\n.button,
\n.formrt button,
...
\n.popup_box.alert-add     { border-color: #762c95; }
\n.popup_box.alert-remove  { border-color: #b4b4b4; }
\n
\n.popup_box .alert-icon [fill]   {   fill: #762c95; }
\n.popup_box .alert-icon [stroke] { stroke: #762c95; }
\n
\n
\n\/\* Header \*\/
\n.header,
...
\n}
\n
\n.header-cart-button [fill] { fill: #762c95; }
\n.header-cart-button [stroke] { stroke: #762c95; }
\n
\n.header-logo img {
\n    height: 62px;
\n    max-height: 62px;
...
\n        background-image: url(\'\/shared_media\/runforliam\/media\/photos\/content\/banner_overlay_left.png\');
\n    }
\n
\n    .banner-slide\-\-right .banner-overlay {
\n        background-image: url(\'\/shared_media\/runforliam\/media\/photos\/content\/banner_overlay_right.png\');
\n    }
\n
...
\n    background: linear-gradient(#0d97e8, #52c5fa);
...
\n        background: linear-gradient(to right, transparent 0, #762c95 10%, #762c95 90%, transparent 100%);
\n    }
\n}
\n
...
\n        background: #762c95;
\n        background: linear-gradient(to right, #E6F3C8 0%, #762c95 20%, #762c95 80%, #E6F3C8 100%);
\n    }
\n}
\n
\n.bar {
...
\n}
\n
\n.panels-feed\-\-bars > :nth-child(3n + 1) .bar-icon { background-color: #ffd021; }
\n.panels-feed\-\-bars > :nth-child(3n + 2) .bar-icon { background-color: #00a651; }
\n.panels-feed\-\-bars > :nth-child(3n) .bar-icon     { background-color: #f161a0; }
\n
\n.bar-icon svg {
\n  fill: #fff;
\n}
...
\n    background-image: url(\'\/shared_media\/runforliam\/media\/photos\/content\/panel_overlay.png\');
\n}
\n
\n.panel-item:nth-child(odd) .panel-item-image:after {
\n    background-image: url(\'\/shared_media\/runforliam\/media\/photos\/content\/panel_overlay_right.png\');
\n}
\n
...
\n\/\* Footer \*\/
\n.footer {
\n    background: #0d97e8 url(\'/shared_media/runforliam/media/photos/content/footer_pattern.svg\') #0d97e8;
...
\n
\n.footer-stats {
\n    background: #fff url(\'\/shared_media\/runforliam\/media\/photos\/content\/footer_background.png\') top center;
\n    min-height: 0;
\n}
\n
\n.footer-stat h2 {
...
\n    background: #762c95;
\n    background: radial-gradient(#6284f0, #762c95);
\n}
\n
...
\n
\n.swiper-button-prev {
\n    background-image: url(\"data:image\/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D\'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg\'%20viewBox%3D\'0%200%2027%2044\'%3E%3Cpath%20d%3D\'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z\'%20fill%3D\'%2352c5fa\'%2F%3E%3C%2Fsvg%3E\");
\n}
\n
\n.swiper-button-next {
\n    background-image: url(\"data:image\/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D\'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg\'%20viewBox%3D\'0%200%2027%2044\'%3E%3Cpath%20d%3D\'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z\'%20fill%3D\'%2352c5fa\'%2F%3E%3C%2Fsvg%3E\");
\n}
\n
\nbody > div > img {
\n  display: block;
