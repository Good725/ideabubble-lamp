/*
ts:2019-11-29 16:30:00
*/

/* Add the '50' (ICSE) theme, if it does not already exist */
DELIMITER  ;;
INSERT INTO
  `engine_site_themes` (`title`, `stub`, `template_id`, `date_created`, `date_modified`)
  SELECT '50', '50', (SELECT `id`  FROM `engine_site_templates` WHERE `stub` = '04' LIMIT 1), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP
    FROM `engine_site_themes`
    WHERE NOT EXISTS (SELECT * FROM `engine_site_themes` WHERE `stub` = '50')
    LIMIT 1
;;


/* Add the '50' theme styles */
UPDATE
  `engine_site_themes`
SET
...
\n
\n:root {
\n    \-\-primary: #2AC4EA;   \-\-primary-hover: #58d0ee;   \-\-primary-active: #15abd1;
\n    \-\-secondary: #f5f5f5; \-\-secondary-hover: #d3d3d3; \-\-secondary-active: #e6e6e6;
\n    \-\-success: #031E56;   \-\-success-hover: #052e80;   \-\-success-active: #010919;
...
\n
\n.form-select:before {
\n    background-image: -webkit-linear-gradient(left, transparent 0, transparent calc(100% - 2.75em), #2AC4EA calc(100% - 2.75em), #2AC4EA 100%);
\n    background-image: linear-gradient(to right, transparent 0, transparent calc(100% - 2.75em), #2AC4EA calc(100% - 2.75em), #2AC4EA 100%);
\n}
\n
\n.button,
\n.formrt button,
...
\n.popup_box.alert-add     { border-color: #2AC4EA; }
\n.popup_box.alert-remove  { border-color: #b4b4b4; }
\n
\n.popup_box .alert-icon [fill]   {   fill: #2AC4EA; }
\n.popup_box .alert-icon [stroke] { stroke: #2AC4EA; }
\n
\n
\n\/\* Header \*\/
\n.header,
...
\n}
\n
\n.header-cart-button [fill] { fill: #031E56; }
\n.header-cart-button [stroke] { stroke: #031E56; }
\n
\n.header-logo img {
\n    height: 32px;
\n    max-height: 32px;
...
\n}
\n
\n.page-content h1 { color: #2AC4EA; font-weight: normal; }
\n.page-content h2 { color: #2AC4EA; font-weight: normal; }
...
\n    background-image: url(\'\/shared_media\/icse\/media\/photos\/content\/banner_overlay_left.png\');
\n    background-position: left;
\n    background-repeat: no-repeat;
\n}
\n
\n.banner-slide\-\-right .banner-overlay .row {
\n    background-image: url(\'\/shared_media\/icse\/media\/photos\/content\/banner_overlay_right.png\');
...
\n    background: linear-gradient(#031E56, #2AC4EA);
...
\n        background: linear-gradient(to right, transparent 0, #2AC4EA 10%, #2AC4EA 90%, transparent 100%);
\n    }
\n}
\n
...
\n        background: #031E56;
\n        background: linear-gradient(to right, #E6F3C8 0%, #031E56 20%, #031E56 80%, #E6F3C8 100%);
\n    }
\n}
\n
\n.bar {
...
\n    background-image: url(\'\/shared_media\/icse\/media\/photos\/content\/panel_overlay.png\');
\n}
\n
\n.panel-item:nth-child(odd) .panel-item-image:after {
\n    background-image: url(\'\/shared_media\/icse\/media\/photos\/content\/panel_overlay_right.png\');
\n}
\n
...
\n    box-shadow: 0 4px 4px rgba(0, 0, 0, .25), inset 0px 4px 4px rgba(0, 0, 0, .25);
\n    min-height: 0;
\n    padding-top: 3.5rem;
\n}
\n
...
\n
\n.swiper-button-prev {
\n    background-image: url(\"data:image\/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D\'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg\'%20viewBox%3D\'0%200%2027%2044\'%3E%3Cpath%20d%3D\'M0%2C22L22%2C0l2.1%2C2.1L4.2%2C22l19.9%2C19.9L22%2C44L0%2C22L0%2C22L0%2C22z\'%20fill%3D\'%232AC4EA\'%2F%3E%3C%2Fsvg%3E\");
\n}
\n
\n.swiper-button-next {
\n    background-image: url(\"data:image\/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D\'http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg\'%20viewBox%3D\'0%200%2027%2044\'%3E%3Cpath%20d%3D\'M27%2C22L27%2C22L5%2C44l-2.1-2.1L22.8%2C22L2.9%2C2.1L5%2C0L27%2C22L27%2C22z\'%20fill%3D\'%232AC4EA\'%2F%3E%3C%2Fsvg%3E\");
\n}
\n
\nbody > div > img {
\n  display: block;
