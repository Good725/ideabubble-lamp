...
class gtld_handler extends WhoisClient
	...
	function parse($data, $query)
		{
		$this->Query = array();
		// $this->SUBVERSION = sprintf('%s-%s', $query['handler'], $this->HANDLER_VERSION); read http://stackoverflow.com/questions/15654076/warning-illegal-string-offset-handler-in-c-wamp-www-whois-whois-whois-gtld-p
