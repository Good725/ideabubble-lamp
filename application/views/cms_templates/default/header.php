                    ...
                    <li id="settings_icon"<?php if ($current_controller === 'settings' AND $current_action == 'index') { echo ' class="active"'; } ?>>
                        <?php if(Auth::instance()->has_access('settings')):?>
                            ...
                            <ul>
								...
								<li><a href="/admin/settings/layouts">Layouts</a></li>
								...
								<li><a href="/admin/settings/templates">Templates</a></li>
								<li><a href="/admin/settings/themes">Themes</a></li>
								<li><a href="/admin/settings/manage_roles">User Roles</a></li>
								<li><a href="/admin/users">Users</a></li>
								<li><a href="/admin/settings/website">Website</a></li>
                            </ul>
                        <?php endif ?>
                    </li>
                    <?php endif; ?>
