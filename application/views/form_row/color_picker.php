<div class="form-group form-group-colorpicker">
    ...
    <div class="col-sm-5">
        <div class="color_picker_wrapper d-flex align-items-center" id="<?= $attributes['id'] ?>-color_picker">
            <div class="select_color_preview" title="Preview" style="background-color:<?= $value ?>"></div>
