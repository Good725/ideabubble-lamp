...
class Kohana_Database_MySQL extends Database {
	...
	public function begin($mode = NULL)
	{
        ...
        if ($this->_transactions_started == 0) {
			$result = (bool)mysql_query('START TRANSACTION', $this->_connection);
		} else {
            $result = true;
        }
	...
	public function commit()
	{
        ...
        if ($this->_transactions_started == 1) {
			$result = (bool)mysql_query('COMMIT', $this->_connection);
		} else {
            $result = true;
        }
	...
	public function rollback()
	{
        ...
        $result = (bool)mysql_query('ROLLBACK', $this->_connection);
        if ($result) {
