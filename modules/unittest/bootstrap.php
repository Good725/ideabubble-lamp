 ...
 */
// additional check to prevent issues with annotation @runInSeparateProcess
if (!defined('EXT'))
    define('EXT', '.php');
...
/**
* Check additional subfolder under  the SYSPATH
* example : wms-engine/system/3-2/
*/
if (!isset($sysPathSuffix))
  $sysPathSuffix = '';
...
if (!defined('SYSPATH'))
    define('SYSPATH', realpath($system).DIRECTORY_SEPARATOR . $sysPathSuffix);
