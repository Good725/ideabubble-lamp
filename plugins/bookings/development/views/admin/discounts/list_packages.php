...
<table class="table table-striped dataTable" id="packages_list_table">
    <thead>
		<tr>
			<th scope="col">ID</th>
    ...
    ?>
		<?php foreach ($discounts AS $key => $discount): ?>
			<tr data-discount_id="<?=$discount['id'];?>">
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?=$discount['id']?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?=$discount['title']?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?=$discount['summary'];?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?
					...
					$detail[] = $discount['schedules'];

                    echo implode(', ', $detail);

				?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?=date('d-m-Y',strtotime($discount['valid_from']));?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'><?=date('d-m-Y',strtotime($discount['valid_to']));?></a></td>
				<td><a href='<?php echo URL::Site('admin/bookings/add_edit_package/'.$discount['id']);?>'>Edit</a></td>
				<td>
					<label>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Are you sure you wish to delete this Package?</p>
			</div>
