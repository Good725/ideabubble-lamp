...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class Model_HTML2PDF
    {
        ...
        /**
         * Clone to create a sub HTML2PDF from Model_HTML2PDF::$_subobj
         *
         * @access public
         */
        ...
        {
            Model_HTML2PDF::$_subobj = null;
            Model_HTML2PDF::$_tables = array();
        }
...
'.$content.'
        ...
        /**
         * prepare Model_HTML2PDF::$_subobj (used for create the sub HTML2PDF objects
         *
         * @access protected
         */
        protected function _prepareSubObj()
        {
            ...
            // create the sub object
            Model_HTML2PDF::$_subobj = new Model_HTML2PDF(
                                        $this->_orientation,
                                        $this->_format,
                                        $this->_langue,
                                        $this->_unicode,
            ...
            // init
            Model_HTML2PDF::$_subobj->setTestTdInOnePage($this->_testTdInOnepage);
            Model_HTML2PDF::$_subobj->setTestIsImage($this->_testIsImage);
            Model_HTML2PDF::$_subobj->setTestIsDeprecated($this->_testIsDeprecated);
            Model_HTML2PDF::$_subobj->setDefaultFont($this->_defaultFont);
            Model_HTML2PDF::$_subobj->parsingCss->css            = &$this->parsingCss->css;
            Model_HTML2PDF::$_subobj->parsingCss->cssKeys        = &$this->parsingCss->cssKeys;

            // clone font from the original PDF
            Model_HTML2PDF::$_subobj->pdf->cloneFontFrom($this->pdf);

            // remove the link to the parent
            Model_HTML2PDF::$_subobj->parsingCss->setPdfParent($pdf);
        }
        ...
        protected function _createSubHTML(&$subHtml, $cellmargin=0)
        {
            ...
            if (Model_HTML2PDF::$_subobj===null) {
                $this->_prepareSubObj();
            }
            ...
            Model_HTML2PDF::$_subobj->pdf->getPage();

            // clone the sub oject
            $subHtml = clone Model_HTML2PDF::$_subobj;
        ...
        protected function _tag_open_THEAD($param)
        {
            ...
            if ($this->_subPart) {
                Model_HTML2PDF::$_tables[$param['num']]['thead']['tr'][0] = Model_HTML2PDF::$_tables[$param['num']]['tr_curr'];
                Model_HTML2PDF::$_tables[$param['num']]['thead']['code'] = array();
                for ($pos=$this->_tempPos; $pos<count($this->parsingHtml->code); $pos++) {
                    ...
                    Model_HTML2PDF::$_tables[$param['num']]['thead']['code'][] = $action;
                    if (strtolower($action['name'])=='thead_sub' && $action['close']) break;
                }
            } else {
                $level = $this->parsingHtml->getLevel($this->_parsePos);
                $this->_parsePos+= count($level);
                Model_HTML2PDF::$_tables[$param['num']]['tr_curr']+= count(Model_HTML2PDF::$_tables[$param['num']]['thead']['tr']);
            }
        ...
        protected function _tag_close_THEAD($param)
        {
            ...
            if ($this->_subPart) {
                $min = Model_HTML2PDF::$_tables[$param['num']]['thead']['tr'][0];
                $max = Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1;
                Model_HTML2PDF::$_tables[$param['num']]['thead']['tr'] = range($min, $max);
            }
        ...
        protected function _tag_open_TFOOT($param)
        {
            ...
            if ($this->_subPart) {
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr'][0] = Model_HTML2PDF::$_tables[$param['num']]['tr_curr'];
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['code'] = array();
                for ($pos=$this->_tempPos; $pos<count($this->parsingHtml->code); $pos++) {
                    $action = $this->parsingHtml->code[$pos];
                    if (strtolower($action['name'])=='tfoot') $action['name'] = 'tfoot_sub';
                    Model_HTML2PDF::$_tables[$param['num']]['tfoot']['code'][] = $action;
                    if (strtolower($action['name'])=='tfoot_sub' && $action['close']) break;
                }
            } else {
                $level = $this->parsingHtml->getLevel($this->_parsePos);
                $this->_parsePos+= count($level);
                Model_HTML2PDF::$_tables[$param['num']]['tr_curr']+= count(Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr']);
            }
        ...
        protected function _tag_close_TFOOT($param)
        {
            ...
            if ($this->_subPart) {
                $min = Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr'][0];
                $max = Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1;
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr'] = range($min, $max);
            }
        ...
        protected function _tag_open_TABLE($param, $other = 'table')
        {
            ...
            if ($this->_subPart) {
                ...
                Model_HTML2PDF::$_tables[$param['num']] = array();
                Model_HTML2PDF::$_tables[$param['num']]['border']          = isset($param['border']) ? $this->parsingCss->readBorder($param['border']) : null;
                Model_HTML2PDF::$_tables[$param['num']]['cellpadding']     = $this->parsingCss->ConvertToMM(isset($param['cellpadding']) ? $param['cellpadding'] : '1px');
                Model_HTML2PDF::$_tables[$param['num']]['cellspacing']     = $this->parsingCss->ConvertToMM(isset($param['cellspacing']) ? $param['cellspacing'] : '2px');
                Model_HTML2PDF::$_tables[$param['num']]['cases']           = array();          // properties of each TR/TD
                Model_HTML2PDF::$_tables[$param['num']]['corr']            = array();          // link between TR/TD and colspan/rowspan
                Model_HTML2PDF::$_tables[$param['num']]['corr_x']          = 0;                // position in 'cases'
                Model_HTML2PDF::$_tables[$param['num']]['corr_y']          = 0;                // position in 'cases'
                Model_HTML2PDF::$_tables[$param['num']]['td_curr']         = 0;                // current column
                Model_HTML2PDF::$_tables[$param['num']]['tr_curr']         = 0;                // current row
                Model_HTML2PDF::$_tables[$param['num']]['curr_x']          = $this->pdf->getX();
                Model_HTML2PDF::$_tables[$param['num']]['curr_y']          = $this->pdf->getY();
                Model_HTML2PDF::$_tables[$param['num']]['width']           = 0;                // global width
                Model_HTML2PDF::$_tables[$param['num']]['height']          = 0;                // global height
                Model_HTML2PDF::$_tables[$param['num']]['align']           = $alignObject;
                Model_HTML2PDF::$_tables[$param['num']]['marge']           = array();
                Model_HTML2PDF::$_tables[$param['num']]['marge']['t']      = $this->parsingCss->value['padding']['t']+$this->parsingCss->value['border']['t']['width']+Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5;
                Model_HTML2PDF::$_tables[$param['num']]['marge']['r']      = $this->parsingCss->value['padding']['r']+$this->parsingCss->value['border']['r']['width']+Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5;
                Model_HTML2PDF::$_tables[$param['num']]['marge']['b']      = $this->parsingCss->value['padding']['b']+$this->parsingCss->value['border']['b']['width']+Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5;
                Model_HTML2PDF::$_tables[$param['num']]['marge']['l']      = $this->parsingCss->value['padding']['l']+$this->parsingCss->value['border']['l']['width']+Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5;
                Model_HTML2PDF::$_tables[$param['num']]['page']            = 0;                // number of pages
                Model_HTML2PDF::$_tables[$param['num']]['new_page']        = true;             // flag : new page for the current TR
                Model_HTML2PDF::$_tables[$param['num']]['style_value']     = null;             // CSS style of the table
                Model_HTML2PDF::$_tables[$param['num']]['thead']           = array();          // properties on the thead
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']           = array();          // properties on the tfoot
                Model_HTML2PDF::$_tables[$param['num']]['thead']['tr']     = array();          // list of the TRs in the thead
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr']     = array();          // list of the TRs in the tfoot
                Model_HTML2PDF::$_tables[$param['num']]['thead']['height']    = 0;             // thead height
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['height']    = 0;             // tfoot height
                Model_HTML2PDF::$_tables[$param['num']]['thead']['code'] = array();            // HTML content of the thead
                Model_HTML2PDF::$_tables[$param['num']]['tfoot']['code'] = array();            // HTML content of the tfoot
                Model_HTML2PDF::$_tables[$param['num']]['cols']        = array();              // properties of the COLs

                $this->_saveMargin($this->pdf->getlMargin(), $this->pdf->gettMargin(), $this->pdf->getrMargin());

                $this->parsingCss->value['width']-= Model_HTML2PDF::$_tables[$param['num']]['marge']['l'] + Model_HTML2PDF::$_tables[$param['num']]['marge']['r'];
            } else {
                // we start from the first page and the first page of the table
                Model_HTML2PDF::$_tables[$param['num']]['page'] = 0;
                Model_HTML2PDF::$_tables[$param['num']]['td_curr']    = 0;
                Model_HTML2PDF::$_tables[$param['num']]['tr_curr']    = 0;
                Model_HTML2PDF::$_tables[$param['num']]['td_x']        = Model_HTML2PDF::$_tables[$param['num']]['marge']['l']+Model_HTML2PDF::$_tables[$param['num']]['curr_x'];
                Model_HTML2PDF::$_tables[$param['num']]['td_y']        = Model_HTML2PDF::$_tables[$param['num']]['marge']['t']+Model_HTML2PDF::$_tables[$param['num']]['curr_y'];

                // draw the borders/background of the first page/part of the table
                $this->_drawRectangle(
                    Model_HTML2PDF::$_tables[$param['num']]['curr_x'],
                    Model_HTML2PDF::$_tables[$param['num']]['curr_y'],
                    Model_HTML2PDF::$_tables[$param['num']]['width'],
                    isset(Model_HTML2PDF::$_tables[$param['num']]['height'][0]) ? Model_HTML2PDF::$_tables[$param['num']]['height'][0] : null,
                    $this->parsingCss->value['border'],
                    $this->parsingCss->value['padding'],
                    0,
                    $this->parsingCss->value['background']
                ...
                Model_HTML2PDF::$_tables[$param['num']]['style_value'] = $this->parsingCss->value;
            }
        ...
        protected function _tag_close_TABLE($param)
        {
            ...
            if ($this->_subPart) {
                ...
                $this->_calculateTableCellSize(Model_HTML2PDF::$_tables[$param['num']]['cases'], Model_HTML2PDF::$_tables[$param['num']]['corr']);

                // calculate the height of the thead and the tfoot
                $lst = array('thead', 'tfoot');
                foreach ($lst as $mode) {
                    Model_HTML2PDF::$_tables[$param['num']][$mode]['height'] = 0;
                    foreach (Model_HTML2PDF::$_tables[$param['num']][$mode]['tr'] as $tr) {
                        // hauteur de la ligne tr
                        $h = 0;
                        for ($i=0; $i<count(Model_HTML2PDF::$_tables[$param['num']]['cases'][$tr]); $i++)
                            if (Model_HTML2PDF::$_tables[$param['num']]['cases'][$tr][$i]['rowspan']==1)
                                $h = max($h, Model_HTML2PDF::$_tables[$param['num']]['cases'][$tr][$i]['h']);
                        Model_HTML2PDF::$_tables[$param['num']][$mode]['height']+= $h;
                    }
                }

                // calculate the width of the table
                Model_HTML2PDF::$_tables[$param['num']]['width'] = Model_HTML2PDF::$_tables[$param['num']]['marge']['l'] + Model_HTML2PDF::$_tables[$param['num']]['marge']['r'];
                if (isset(Model_HTML2PDF::$_tables[$param['num']]['cases'][0])) {
                    foreach (Model_HTML2PDF::$_tables[$param['num']]['cases'][0] as $case) {
                        Model_HTML2PDF::$_tables[$param['num']]['width']+= $case['w'];
                    }
                }
                ...
                $old = $this->parsingCss->getOldValues();
                $parentWidth = $old['width'] ? $old['width'] : $this->pdf->getW() - $this->pdf->getlMargin() - $this->pdf->getrMargin();
                $x = Model_HTML2PDF::$_tables[$param['num']]['curr_x'];
                $w = Model_HTML2PDF::$_tables[$param['num']]['width'];
                if ($parentWidth>$w) {
                    if (Model_HTML2PDF::$_tables[$param['num']]['align']=='center')
                        $x = $x + ($parentWidth-$w)*0.5;
                    else if (Model_HTML2PDF::$_tables[$param['num']]['align']=='right')
                        $x = $x + $parentWidth-$w;

                    Model_HTML2PDF::$_tables[$param['num']]['curr_x'] = $x;
                }

                // calculate the height of the table
                Model_HTML2PDF::$_tables[$param['num']]['height'] = array();

                // minimum of the height because of margins, and of the thead and tfoot height
                $h0 = Model_HTML2PDF::$_tables[$param['num']]['marge']['t'] + Model_HTML2PDF::$_tables[$param['num']]['marge']['b'];
                $h0+= Model_HTML2PDF::$_tables[$param['num']]['thead']['height'] + Model_HTML2PDF::$_tables[$param['num']]['tfoot']['height'];

                // max height of the page
                $max = $this->pdf->getH() - $this->pdf->getbMargin();

                // current position on the page
                $y = Model_HTML2PDF::$_tables[$param['num']]['curr_y'];
                $height = $h0;

                // we get the height of each line
                for ($k=0; $k<count(Model_HTML2PDF::$_tables[$param['num']]['cases']); $k++) {

                    // if it is a TR of the thead or of the tfoot => skip
                    if (in_array($k, Model_HTML2PDF::$_tables[$param['num']]['thead']['tr'])) continue;
                    if (in_array($k, Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr'])) continue;

                    // height of the line
                    $th = 0;
                    $h = 0;
                    for ($i=0; $i<count(Model_HTML2PDF::$_tables[$param['num']]['cases'][$k]); $i++) {
                        $h = max($h, Model_HTML2PDF::$_tables[$param['num']]['cases'][$k][$i]['h']);

                        if (Model_HTML2PDF::$_tables[$param['num']]['cases'][$k][$i]['rowspan']==1)
                            $th = max($th, Model_HTML2PDF::$_tables[$param['num']]['cases'][$k][$i]['h']);
                    }

                    // if the row does not fit on the page => new page
                    if ($y+$h+$height>$max) {
                        if ($height==$h0) $height = null;
                        Model_HTML2PDF::$_tables[$param['num']]['height'][] = $height;
                        $height = $h0;
                        $y = $this->_margeTop;
                    }
                    $height+= $th;
                ...
                if ($height!=$h0 || $k==0) Model_HTML2PDF::$_tables[$param['num']]['height'][] = $height;
            } else {
                // if we have tfoor, draw it
                if (count(Model_HTML2PDF::$_tables[$param['num']]['tfoot']['code'])) {
                    $tmpTR = Model_HTML2PDF::$_tables[$param['num']]['tr_curr'];
                    $tmpTD = Model_HTML2PDF::$_tables[$param['num']]['td_curr'];
                    $oldParsePos = $this->_parsePos;
                    $oldParseCode = $this->parsingHtml->code;

                    Model_HTML2PDF::$_tables[$param['num']]['tr_curr'] = Model_HTML2PDF::$_tables[$param['num']]['tfoot']['tr'][0];
                    Model_HTML2PDF::$_tables[$param['num']]['td_curr'] = 0;
                    $this->_parsePos = 0;
                    $this->parsingHtml->code = Model_HTML2PDF::$_tables[$param['num']]['tfoot']['code'];
                    ...
                    $this->_parsePos =     $oldParsePos;
                    $this->parsingHtml->code = $oldParseCode;
                    Model_HTML2PDF::$_tables[$param['num']]['tr_curr'] = $tmpTR;
                    Model_HTML2PDF::$_tables[$param['num']]['td_curr'] = $tmpTD;
                }

                // get the positions of the end of the table
                $x = Model_HTML2PDF::$_tables[$param['num']]['curr_x'] + Model_HTML2PDF::$_tables[$param['num']]['width'];
                if (count(Model_HTML2PDF::$_tables[$param['num']]['height'])>1)
                    $y = $this->_margeTop+Model_HTML2PDF::$_tables[$param['num']]['height'][count(Model_HTML2PDF::$_tables[$param['num']]['height'])-1];
                else if (count(Model_HTML2PDF::$_tables[$param['num']]['height'])==1)
                    $y = Model_HTML2PDF::$_tables[$param['num']]['curr_y']+Model_HTML2PDF::$_tables[$param['num']]['height'][count(Model_HTML2PDF::$_tables[$param['num']]['height'])-1];
                else
                    $y = Model_HTML2PDF::$_tables[$param['num']]['curr_y'];
        ...
        protected function _tag_open_COL($param)
        {
            ...
            for ($k=0; $k<$span; $k++)
                Model_HTML2PDF::$_tables[$param['num']]['cols'][] = $param;
        }
        ...
        protected function _tag_open_TR($param, $other = 'tr')
        {
            ...
            Model_HTML2PDF::$_tables[$param['num']]['tr_curr']++;
            Model_HTML2PDF::$_tables[$param['num']]['td_curr']= 0;
            ...
            if (!$this->_subPart) {
                ...
                // Y after the row
                $ty=null;
                for ($ii=0; $ii<count(Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1]); $ii++) {
                    $ty = max($ty, Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][$ii]['h']);
                }

                // height of the tfoot
                $hfoot = Model_HTML2PDF::$_tables[$param['num']]['tfoot']['height'];

                // if the line does not fit on the page => new page
                if (!$this->_isInTfoot && Model_HTML2PDF::$_tables[$param['num']]['td_y'] + Model_HTML2PDF::$_tables[$param['num']]['marge']['b'] + $ty +$hfoot> $this->pdf->getH() - $this->pdf->getbMargin()) {
                    ...
                    // new page
                    Model_HTML2PDF::$_tables[$param['num']]['new_page'] = true;
                    $this->_setNewPage();

                    // new position
                    Model_HTML2PDF::$_tables[$param['num']]['page']++;
                    Model_HTML2PDF::$_tables[$param['num']]['curr_y'] = $this->pdf->getY();
                    Model_HTML2PDF::$_tables[$param['num']]['td_y'] = Model_HTML2PDF::$_tables[$param['num']]['curr_y']+Model_HTML2PDF::$_tables[$param['num']]['marge']['t'];

                    // if we have the height of the tbale on the page => draw borders and background
                    if (isset(Model_HTML2PDF::$_tables[$param['num']]['height'][Model_HTML2PDF::$_tables[$param['num']]['page']])) {
                        $old = $this->parsingCss->value;
                        $this->parsingCss->value = Model_HTML2PDF::$_tables[$param['num']]['style_value'];

                        $this->_drawRectangle(
                            Model_HTML2PDF::$_tables[$param['num']]['curr_x'],
                            Model_HTML2PDF::$_tables[$param['num']]['curr_y'],
                            Model_HTML2PDF::$_tables[$param['num']]['width'],
                            Model_HTML2PDF::$_tables[$param['num']]['height'][Model_HTML2PDF::$_tables[$param['num']]['page']],
                            $this->parsingCss->value['border'],
                            $this->parsingCss->value['padding'],
                            Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5,
                            $this->parsingCss->value['background']
                        );
                ...
                if (Model_HTML2PDF::$_tables[$param['num']]['new_page'] && count(Model_HTML2PDF::$_tables[$param['num']]['thead']['code'])) {
                    Model_HTML2PDF::$_tables[$param['num']]['new_page'] = false;
                    $tmpTR = Model_HTML2PDF::$_tables[$param['num']]['tr_curr'];
                    $tmpTD = Model_HTML2PDF::$_tables[$param['num']]['td_curr'];
                    $oldParsePos = $this->_parsePos;
                    $oldParseCode = $this->parsingHtml->code;

                    Model_HTML2PDF::$_tables[$param['num']]['tr_curr'] = Model_HTML2PDF::$_tables[$param['num']]['thead']['tr'][0];
                    Model_HTML2PDF::$_tables[$param['num']]['td_curr'] = 0;
                    $this->_parsePos = 0;
                    $this->parsingHtml->code = Model_HTML2PDF::$_tables[$param['num']]['thead']['code'];
            ...
            // else (in a sub HTML)
                ...
                // prepare it
                Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1] = array();
                if (!isset(Model_HTML2PDF::$_tables[$param['num']]['corr'][Model_HTML2PDF::$_tables[$param['num']]['corr_y']]))
                    Model_HTML2PDF::$_tables[$param['num']]['corr'][Model_HTML2PDF::$_tables[$param['num']]['corr_y']] = array();

                Model_HTML2PDF::$_tables[$param['num']]['corr_x']=0;
                while(isset(Model_HTML2PDF::$_tables[$param['num']]['corr'][Model_HTML2PDF::$_tables[$param['num']]['corr_y']][Model_HTML2PDF::$_tables[$param['num']]['corr_x']]))
                    Model_HTML2PDF::$_tables[$param['num']]['corr_x']++;
            }
        ...
        protected function _tag_close_TR($param)
        {
            ...
            if (!$this->_subPart) {
                ...
                $ty=null;
                for ($ii=0; $ii<count(Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1]); $ii++) {
                    if (Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][$ii]['rowspan']==1) {
                        $ty = Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][$ii]['h'];
                    }
                }

                // new position
                Model_HTML2PDF::$_tables[$param['num']]['td_x'] = Model_HTML2PDF::$_tables[$param['num']]['curr_x']+Model_HTML2PDF::$_tables[$param['num']]['marge']['l'];
                Model_HTML2PDF::$_tables[$param['num']]['td_y']+= $ty;
                Model_HTML2PDF::$_tables[$param['num']]['new_page'] = false;
            } else {
                Model_HTML2PDF::$_tables[$param['num']]['corr_y']++;
            }
        ...
        protected function _tag_open_TD($param, $other = 'td')
        {
            ...
            $param['cellpadding'] = Model_HTML2PDF::$_tables[$param['num']]['cellpadding'].'mm';
            $param['cellspacing'] = Model_HTML2PDF::$_tables[$param['num']]['cellspacing'].'mm';
            ...
            $x = Model_HTML2PDF::$_tables[$param['num']]['td_curr'];
            $y = Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1;
            ...
            if (in_array($other, array('td', 'th'))) {
                // id of the column
                $numCol = isset(Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['Xr']) ? Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['Xr'] : Model_HTML2PDF::$_tables[$param['num']]['corr_x'];

                // we get the properties of the COL tag, if exist
                if (isset(Model_HTML2PDF::$_tables[$param['num']]['cols'][$numCol])) {

                    $colParam = Model_HTML2PDF::$_tables[$param['num']]['cols'][$numCol];

                    // for colspans => we get all the neede widths
                    $colParam['style']['width'] = array();
                    for ($k=0; $k<$colspan; $k++) {
                        if (isset(Model_HTML2PDF::$_tables[$param['num']]['cols'][$numCol+$k]['style']['width'])) {
                            $colParam['style']['width'][] = Model_HTML2PDF::$_tables[$param['num']]['cols'][$numCol+$k]['style']['width'];
                        }
                    }
            ...
            if (in_array($other, array('td', 'th'))) {
                ...
                if (Model_HTML2PDF::$_tables[$param['num']]['border']) {
                    $legacy['border'] = array();
                    $legacy['border']['l'] = Model_HTML2PDF::$_tables[$param['num']]['border'];
                    $legacy['border']['t'] = Model_HTML2PDF::$_tables[$param['num']]['border'];
                    $legacy['border']['r'] = Model_HTML2PDF::$_tables[$param['num']]['border'];
                    $legacy['border']['b'] = Model_HTML2PDF::$_tables[$param['num']]['border'];
                }
            }
            ...
            if ($collapse) {
                if (!$this->_subPart) {
                    if (
                        (Model_HTML2PDF::$_tables[$param['num']]['tr_curr']>1 && !Model_HTML2PDF::$_tables[$param['num']]['new_page']) ||
                        (!$this->_isInThead && count(Model_HTML2PDF::$_tables[$param['num']]['thead']['code']))
                    ) {
                        $this->parsingCss->value['border']['t'] = $this->parsingCss->readBorder('none');
                    }
                }

                if (Model_HTML2PDF::$_tables[$param['num']]['td_curr']>0) {
            ...
            $marge = array();
            $marge['t'] = $this->parsingCss->value['padding']['t']+0.5*Model_HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['t']['width'];
            $marge['r'] = $this->parsingCss->value['padding']['r']+0.5*Model_HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['r']['width'];
            $marge['b'] = $this->parsingCss->value['padding']['b']+0.5*Model_HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['b']['width'];
            $marge['l'] = $this->parsingCss->value['padding']['l']+0.5*Model_HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['l']['width'];

            // if we are in a sub HTML
            if ($this->_subPart) {
                // new position in the table
                Model_HTML2PDF::$_tables[$param['num']]['td_curr']++;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x] = array();
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['w'] = 0;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['h'] = 0;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['dw'] = 0;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['colspan'] = $colspan;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['rowspan'] = $rowspan;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['Xr'] = Model_HTML2PDF::$_tables[$param['num']]['corr_x'];
                Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['Yr'] = Model_HTML2PDF::$_tables[$param['num']]['corr_y'];

                // prepare the mapping for rowspan and colspan
                for ($j=0; $j<$rowspan; $j++) {
                    for ($i=0; $i<$colspan; $i++) {
                        Model_HTML2PDF::$_tables[$param['num']]['corr']
                            [Model_HTML2PDF::$_tables[$param['num']]['corr_y']+$j]
                            [Model_HTML2PDF::$_tables[$param['num']]['corr_x']+$i] = ($i+$j>0) ? '' : array($x,$y,$colspan,$rowspan);
                    }
                }
                Model_HTML2PDF::$_tables[$param['num']]['corr_x']+= $colspan;
                while (isset(Model_HTML2PDF::$_tables[$param['num']]['corr'][Model_HTML2PDF::$_tables[$param['num']]['corr_y']][Model_HTML2PDF::$_tables[$param['num']]['corr_x']])) {
                    Model_HTML2PDF::$_tables[$param['num']]['corr_x']++;
                }
                ...
                // new position in the table
                Model_HTML2PDF::$_tables[$param['num']]['td_curr']++;
                Model_HTML2PDF::$_tables[$param['num']]['td_x']+= Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['dw'];

                // borders and background of the TD
                $this->_drawRectangle(
                    Model_HTML2PDF::$_tables[$param['num']]['td_x'],
                    Model_HTML2PDF::$_tables[$param['num']]['td_y'],
                    Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['w'],
                    Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['h'],
                    $this->parsingCss->value['border'],
                    $this->parsingCss->value['padding'],
                    Model_HTML2PDF::$_tables[$param['num']]['cellspacing']*0.5,
                    $this->parsingCss->value['background']
                ...
                $this->parsingCss->value['width'] = Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['w'] - $marge['l'] - $marge['r'];

                // marges = size of the TD
                $mL = Model_HTML2PDF::$_tables[$param['num']]['td_x']+$marge['l'];
                $mR = $this->pdf->getW() - $mL - $this->parsingCss->value['width'];
                $this->_saveMargin($mL, 0, $mR);

                // position of the content, from vertical-align
                $hCorr = Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['h'];
                $hReel = Model_HTML2PDF::$_tables[$param['num']]['cases'][$y][$x]['real_h'];
                switch($this->parsingCss->value['vertical-align'])
                {
                    case 'bottom':
                        $yCorr = $hCorr-$hReel;
                ...
                $x = Model_HTML2PDF::$_tables[$param['num']]['td_x']+$marge['l'];
                $y = Model_HTML2PDF::$_tables[$param['num']]['td_y']+$marge['t']+$yCorr;
                $this->pdf->setXY($x, $y);
                $this->_setNewPositionForNewLine();
            }
        ...
        protected function _tag_close_TD($param)
        {
            ...
            if ($this->_subPart) {
                ...
                Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][Model_HTML2PDF::$_tables[$param['num']]['td_curr']-1]['w'] = max(array($w0, $w2));
                Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][Model_HTML2PDF::$_tables[$param['num']]['td_curr']-1]['h'] = max(array($h0, $h2));

                // real position of the content
                Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][Model_HTML2PDF::$_tables[$param['num']]['td_curr']-1]['real_w'] = $w0;
                Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][Model_HTML2PDF::$_tables[$param['num']]['td_curr']-1]['real_h'] = $h0;
                ...
                Model_HTML2PDF::$_tables[$param['num']]['td_x']+= Model_HTML2PDF::$_tables[$param['num']]['cases'][Model_HTML2PDF::$_tables[$param['num']]['tr_curr']-1][Model_HTML2PDF::$_tables[$param['num']]['td_curr']-1]['w'];
            }
