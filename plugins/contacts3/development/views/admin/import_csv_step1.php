...
<form class="col-sm-12 form-horizontal" id="form_import_csv" name="form_import_csv" action="/admin/contacts3/import_csv?step=2" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <p>You can use this file as a sample: <a href="/admin/contacts3/sample_csv_import">download</a></p>
    </fieldset>
