...
Relationship to Student: <?=(@$form['guardian_relationship_to_student'] == 'other')?@$form['guardian_relationship_to_student_other']:@$form['guardian_relationship_to_student']?><br/>
...
Relationship to Student: <?=(@$form['student_relationship_to_student'] == 'other')?@$form['student_relationship_to_student_other']:@$form['student_relationship_to_student']?><br/>
