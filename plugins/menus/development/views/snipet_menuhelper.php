<ul class="<?=$class_name;?>" >
    ...
    <li id="item_<?=$menulv0['id']?>" class="level_<?=$menulv0['level']?> item_<?=$menulv0['item_number']?> <?=$menulv0['first']?> <?=$menulv0['last']?> <?=$menulv0['current']?>"><a target="<?=$menulv0['menus_target']?>" href="<?=$menulv0['link']?>"><?=$menulv0['title']?></a>
