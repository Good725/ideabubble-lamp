	...
	<div class="padding10">
		...
		<div class="full-grid margin-bottom-15">   
			...
			<ul class="set-interval">
				<li>
					Minutes<label class="icon-wrap"><input value="02:00am" type="text"><i class="fa icon-clock-o" aria-hidden="true"></i></label>
				</li>
				<li>
					Hours<label class="icon-wrap"><input value="02:00am" type="text"><i class="fa icon-clock-o" aria-hidden="true"></i></label>
				</li>
				<li>
					Dates<label class="icon-wrap"><input value="02:00am" type="text"><i class="fa icon-calendar" aria-hidden="true"></i></label>
				</li>
				<li>
					Months<label class="icon-wrap"><input value="02:00am" type="text"><i class="fa icon-calendar" aria-hidden="true"></i></label>
				</li>
			</ul>
		</div>
		<div class="sub-title"><h3>Days in Week</h3></div>
		<ul class="week-name">
