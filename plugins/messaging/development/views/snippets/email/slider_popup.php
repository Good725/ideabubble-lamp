	...
	<div class="screenTable">
		<div class="screenCell">
			<div class="sectioninner">
				<a class="popup_close"><i class="fa icon-times" aria-hidden="true"></i></a>
				<div class="popup-content">
					 <ul class="attachment-slider" id="attachment-slider">
						<li>
					...
					<ul class="slider-nav" id="attachment-slider-nav">
						<li>
							<div class="imgbox">
								<img src="<?php echo URL::get_engine_plugin_assets_base('messaging');?>/images/slider-img.jpg">
							</div>
