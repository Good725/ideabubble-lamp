/*
ts:2016-03-03 09:40:00
*/
ALTER IGNORE TABLE `plugin_pages_pages` ADD COLUMN `parent_id` INT(10) NULL DEFAULT NULL AFTER `category_id` ;
...
plugin_pages_pages.parent_id AS parent_id,
