<p>An order has been posted through the <a href="<?= URL::base() ?>"><?= URL::base() ?></a> website</p>
...
<p>
	...
	<?= (isset($booking['last_name'])  AND $booking['last_name'] != '') ? $booking['last_name'] : (isset($data->last_name) ? $data->last_name : '') ?>
	<br/>
    ...
    <?php if ($mobile): ?>
        Mobile: <?= $mobile ?><br/>
    <?php endif; ?>
	Email: <?= (isset($booking['email']) AND $booking['email'] != '') ? $booking['email'] : (isset($data->email) ? $data->email : '') ?>
	<br/>
...
<?php } ?>
TOTAL:
<b>&euro;<?= (is_array($data) AND isset($data['mc_gross'])) ? $data['mc_gross'] : (isset($data->amount) ? $data->amount : '') ?></b><br/><br/>


Comments: <?= isset($booking['comments']) ? $booking['comments'] : (isset($data->comments) ? $data->comments : '') ?>
<br/><br/>

<p>Thank you for your custom.</p>

<p>Kind regards,<br /><a href="<?= URL::base() ?>"><?= URL::base() ?></a></p>
