			...
			<div class="left product_category">
				<div class="left product_category_image">
						...
						<?php
							...
							echo '<img alt="',__($category),'" src="',Model_Media::get_path_to_media_item_admin(Kohana::$config->load('config')->project_media_folder,$image, Model_Product::MEDIA_IMAGES_FOLDER."/_thumbs".DIRECTORY_SEPARATOR),'">';
						?>
				</div>
