...
//   Set to any of: TEST for the Test Server and LIVE for the live environment
    'env' => Settings::instance()->get('sagepay_test') == 1 ? 'test' : 'live',
...
// Mandatory. Set this value to the Vendor Name assigned to you by Sage Pay or chosen when you applied
    'vendorName' => Settings::instance()->get('sagepay_vendor'),
...
// See the protocol docs for further explanation on using the surcharge xml. 	
    ...
    array(
        array(
            'paymentType' => 'MC',
            'percentage' => Settings::instance()->get('sagepay_surcharge_mc'),
        ),
        array(
            'paymentType' => 'VISA',
            'fixed' => Settings::instance()->get('sagepay_surcharge_visa'),
        ),
    ),
...
//  Mandatory property, set this value to the Encryption password assigned to you by Sage Pay 	
    'formPassword' =>
    array(
        'test' => Settings::instance()->get('sagepay_password'),
        'live' => Settings::instance()->get('sagepay_password'),
    ),
// Mandatory parameters form notifications URLs appended to siteFQDN value
    'formSuccessUrl' => URL::site('frontend/sagepay/pay/success'),
    'formFailureUrl' => URL::site('frontend/sagepay/pay/fail'),
...
// Mandatory Server notification URLs
    'serverNotificationUrl' => URL::site('frontend/sagepay/notify'),
// Optional
