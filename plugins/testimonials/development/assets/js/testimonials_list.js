$(document).ready(function(){
    ...
    $(".publish").on("click", function(event){
		...
		//Toggle Publish
		$.post(
				'/admin/testimonials/ajax_toggle_publish',
				{
	...
	$(".delete").on("click", function(event){
		...
		var ok_to_delete = confirm(
				'You are about to DELETE a Testimonial #'+item_id_parts[1]+
				'\n\nPlease NOTE that this cannot be un-done!\n\n'+
				'Do you want to DELETE Testimonial #'+item_id_parts[1]
		);
		...
		if(ok_to_delete){
			...
			//Delete Item
			$.post(
					'/admin/testimonials/ajax_toggle_delete',
					{
						item_id : item_id_parts[1]
					},
					function(response){
