...
INSERT IGNORE INTO `engine_resources` (`type_id`, `alias`, `name`, `description`) VALUES (0, 'testimonials', 'Testimonials', 'Testimonials');
...
(
  ...
  (SELECT `id` FROM `engine_resources` WHERE `alias` = 'testimonials')
);
INSERT IGNORE INTO `engine_role_permissions` (`role_id`, `resource_id`) VALUES
(
