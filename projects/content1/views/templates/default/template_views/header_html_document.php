...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link href="/assets/shared/css/eventCalendar.css" rel="stylesheet" type="text/css" />
		<link href="/assets/shared/css/eventCalendar_theme_responsive.css" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript">window.jQuery || document.write('<script src="<?=URL::site()?>assets/<?= $assets_folder_path ?>/js/jquery-1.7.2.min.js"><\/script>')</script>
        ...
        <?php if(Settings::instance()->get('responsive_enabled') == "TRUE"):?>
            ...
            <!--[if lt IE 9]>
                <script type="text/javascript" src="<?= URL::site() ?>assets/default/js/respond.src.js"></script>
            <![endif]-->
        <?php endif;?>
		<script type="text/javascript" src="/assets/shared/js/jquery.eventCalendar.js"></script>
