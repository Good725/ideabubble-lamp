...
<div class="home-panels">
	<div class="row">
		...
		$side_panels    = $panel_model->get_panels('content_left',   (Settings::instance()->get('localisation_content_active') == '1'));
		?>
...
<div class="row">
	<div class="small-12 medium-12 columns page-content">
		<?php if (count($side_panels) > 0): ?>
			<div class="small-12 medium-5 columns side-panels content2-side-panels">
