...
<html>
    <body>
        ...
        <table>
			<?php if (isset($checkout->payment_ref) && @$checkout->payment_ref != ''): ?>
				<tr>
			...
			<?php if (isset($checkout->payment_form_name)) { ?>
				<tr>
					<td>Name: <?= isset($checkout->payment_form_name) ? $checkout->payment_form_name : ''; ?></td>
					<td>Phone: <?= isset($checkout->phone) ? $checkout->phone : ''; ?></td>
				</tr>
			<?php } ?>

			<?php if (isset($checkout->name)) { ?>
            <tr>
