    ...
    <section class="banner-section <?= ( ! empty($page_data['banner_slides'])) ? 'banner-section--sequence' : 'banner-section--single'?> home-banner">
        <?php if ( ! empty($page_data['banner_slides'])): ?>
            <div class="swiper-container" id="home-banner-swiper"
                 ...
                 data-direction="<?= ( ! empty($page_data['banner_sequence_type']) && $page_data['banner_sequence_type'] == 'vertical') ? 'vertical' : 'horizontal' ?>"
                 data-effect="<?= ( ! empty($page_data['banner_sequence_type']) && $page_data['banner_sequence_type'] == 'fade') ? 'fade' : 'slide' ?>"
