...
$realex_enabled = (Settings::instance()->get('realex_username') == '') ? FALSE : TRUE;
...
<style type="text/css">
    ...
    #method_3 {
        background-image: url('<?=URL::site();?>assets/img/stripe_logo.png');
        display: block;
        width: 149px;
        height: 55px;
        float: left;
...
<?php if ( ! empty($products_list)): ?>
				...
				<div id="checkoutTable">
					...
					<div class="checkout-settings">
						<div class="checkout-settings-cl checkout-settings-delivery">
							...
							<div class="checkout-settings-row" id="checkout_postal_zone_wrapper">
							...
							<span class="continue-shopping">
								<?php if (($last_category = Session::instance()->get('last_category')) !== NULL): ?>
									<a href="<?= $last_category ?>"Continue Shopping >></a>
						...
						<div id="paymentSelect" class="paymentSelect"<?= ($payment_method_count <= 1) ? ' style="display: none;"' : '' ?>>
							...
							<div>
								...
								<select id="payment_method_selector" style="display:none;">
									<?php if ($realex_enabled || $sagepay_enabled): ?>
						...
						<div id="CartDetailsBox">
								...
								<table class="CartDetails">
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" style="width: 200px;" maxlength="70" name="address_1" id="address_1" class="validate[required] text-input"
										...
										<tr>
											...
											<td>
												...
												<?php else: ?>
													<select id="address_4" class="validate[required]">
														<?php foreach (Model_Sagepay::$countries as $country): ?>
															<option <?=$country == 'Ireland' ? 'selected="selected"' : ''?>><?= $country ?></option>
														<?php endforeach; ?>
													</select>
												<?php endif; ?>
											</td>
										...
										<tr>
											...
											<td>
												<input type="text" maxlength="20" name="postcode" id="postcode" value="" class="validate[required] text-input">
											</td>
										</tr>
										<tr>
									...
									<tbody>
										...
										<tr>
											<td colspan="2" class="credit_cards">
												...
												<img alt="Sage Pay" src="<?= URL::get_engine_plugin_assets_base('products') ?>images/sagepay-logo.png">
											</td>
										</tr>
										<tr>
											<td colspan="2">
							...
							<div id="payment_button_area">
								...
								<div id="paypalButton" class="payment_method_view"<?= ($default_payment != 'PayPal') ? ' style="display:none;"' : ''; ?>>
									<a href="<?= "javascript:CHECKOUT.checkoutWithPayPal('" . URL::site() . "thanks-for-shopping-with-us.html', '" . URL::site() . "', function(status,data){ checkout_data.paypal_error(status,data); });" ?>">
    ...
    <div id="collect_dialogue" class="ui-dialog" title="Collect in Store" style="display:none;">
        <p>We will notify you by email when your order is ready to be collected. Please allow up to 48hrs for collection. If you have any queries please email - info@pcsystems.ie".</p>
    </div>
    <?php
