...
<div class="socialmedia">
    <div class="sharethis">
        ...
        <?php endif; ?>
		<?php if ($twitter_url != ''):?>
			<a name="twitter_link" type="button_count" href="<?=$twitter_url?>"><img src="<?=URL::site()?>assets/default/images/twitter-logo.png" alt="" height="20" /></a>
		<?php endif; ?>
		<?php if ($linkedin_url != ''):?>
			<a name="linkedin_link" type="button_count" href="<?=$linkedin_url?>"><img src="<?=URL::site()?>assets/default/images/linkedin-logo.png" alt="" height="20" /></a>
		<?php endif; ?>
    </div>
</div>
<!-- /Social Media -->