$(document).ready(function(){
    ...
    var topSubcategoryFilter = $('#top-subcategory-filter');
    var topCategoryFilter = $('#top-category-filter');
    topCategoryFilter.change(function(){
		var category_id = $(this).val();
        $.get('/frontend/products/get_subcategories?id=' + category_id, function(data){
            data = $.parseJSON(data);
            data = '<option value="sub-category">Select Subcategory</option>' + data;
			topSubcategoryFilter.attr("name", "sub_category_id[" + category_id + "]");
            topSubcategoryFilter.html(data);
        });
    });
