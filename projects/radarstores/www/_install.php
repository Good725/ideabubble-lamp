...
function fix_path($relativePath)
{
	$pattern = '/\w+\/\.\.\//';
...
<body>
 ...
 ?>
			...
			<?php if (is_dir(APPPATH) AND is_dir(fix_path(APPPATH.'../../../cache/')) AND is_writable(fix_path(APPPATH.'../../../cache/'))): ?>
				<td class="pass"><?php echo fix_path(APPPATH.'../../../cache/'); ?></td>
			<?php else: $failed = TRUE ?>
				<td class="fail">The <code><?php echo fix_path(APPPATH.'../../../cache/'); ?></code> directory is not writable.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>Logs Directory</th>
			<?php if (is_dir(APPPATH) AND is_dir(fix_path(APPPATH.'../../../logs/')) AND is_writable(fix_path(APPPATH.'../../../logs/'))): ?>
				<td class="pass"><?php echo fix_path(APPPATH.'../../../logs/') ?></td>
			<?php else: $failed = TRUE ?>
				<td class="fail">The <code><?php echo fix_path(APPPATH.'../../../logs/') ?></code> directory is not writable.</td>
			<?php endif ?>
		</tr>
		<tr>
			<th>PCRE UTF-8</th>
