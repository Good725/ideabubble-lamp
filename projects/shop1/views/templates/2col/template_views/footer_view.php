...
<div id="footer" class="left">
    ...
    <div class="row_3">
        ...
        <div class="left left-100">
            <img id="footer_img5" src="<?= URL::get_skin_urlpath(TRUE) ?>images/footer-img05.jpg" alt="Payment"
                 title="Payment"/>
            <img id="footer_img5" src="<?= URL::get_skin_urlpath(TRUE) ?>images/footer-img06.jpg" alt="Payment"
                 title="Payment"/>
            <img id="footer_img6" src="<?= URL::get_skin_urlpath(TRUE) ?>images/footer-img07.jpg" alt="Payment"
                 title="Payment"/>
            <img id="footer_img7" src="<?= URL::get_skin_urlpath(TRUE) ?>images/footer-img08.jpg" alt="Payment"
                 title="Payment"/>
            <img id="footer_img8" src="<?= URL::get_skin_urlpath(TRUE) ?>images/footer-img09.jpg" alt="Payment"
                 title="Payment"/>
        </div>
    </div>
</div>
