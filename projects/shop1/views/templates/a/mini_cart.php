...
<div id="checkout_cart"<?= (Settings::instance()->get('cart_hidden_when_empty') == 1) ? ' class="minicart-hidden-when-empty"' : ''; ?> data-product_count="<?= $number_of_items ?>">
    <div class="mycart">
        <?php if (Settings::instance()->get('enable_card_builder') == 1): ?>
            <?php $logged_in_user = Auth::instance()->get_user(); ?>
            <?php if (isset($logged_in_user['id'])): ?>
                <div class="mycart_section mycart_username"><?= $logged_in_user['name'].' '.$logged_in_user['surname'] ?></div>
                <div class="mycart_section"><a href="/card-builder-orders.html">View Orders</a></div>
                <div class="mycart_section mycart_logout"><a href="/frontend/users/logout">Log out</a></div>
            <?php else: ?>
                <div class="mycart_section mycart_login"><a href="/login.html">Log in</a></div>
            <?php endif; ?>
        <?php else: ?>
            <div class="mycart_summary">
                <div class="mycart_summary_txt"><a href="/checkout.html">Shopping Cart</a></div><div class="amount"><span class="mycart_items_amount"><?=Model_Checkout::get_cart_value('number_of_items')?></span></div>
                    ...
                    <div class="mycart_summary_details mycart_details">
                        <?php foreach($cart->lines as $line_number =>$line): ?>
                            ...
                            <div class="mycart_summary_details_line product_line" data-product_id="<?=$line->product->id?>" data-line_id="<?=$line_number?>">
                                <div class="mycart_summary_img" data-x="x"><?=$thumbnail?></div>
                        ...
                        <a href="/checkout.html">
                            <div class="left pl_button" id="pl_member_registration_button" name="pl_member_registration_button" type="button">Checkout</div>
                        </a>
                    </div>
                <?php endif; ?>
            </div>
