...
<div class="footer_body">
    ...
    <div class="about_us">
        <h4 class="quick_links_header">About Us</h4>
        <div class="menu_footer">
            <?php menuhelper::add_menu_editable_heading('about us')?>
        </div>
    </div>
        ...
        <div id="newsletter_wrapper">
            ...
            <form class="form-newsletter" id="form-newsletter" action="/frontend/formprocessor" method="post">
                ...
                <div class="row">
                    ...
                    <input type="text" name="<?=$form_identifier;?>form_name" id="<?= $form_identifier ?>form_name" class="validate[required]" placeholder="Name"/>
                </div>

                <div class="row">
                    <div class="label"><label for="<?= $form_identifier ?>form_email_address">Email</label></div>
                    <input type="text" name="<?=$form_identifier;?>form_email_address" id="<?= $form_identifier ?>form_email_address" class="validate[required,custom[email]]" placeholder="Email" />
                </div>
                ...
                <?php if (Settings::instance()->get('captcha_enabled') && Settings::instance()->get('newsletter_subscription_captcha')): ?>
                    ...
                    <div class="captcha-section hidden" id="newsletter-captcha-section">
                        <input type="text" class="captcha-section-hidden_field validate[required]" id="form-newsletter-captcha-hidden" tabindex="-1" />
