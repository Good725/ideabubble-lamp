...
<div id="related_<?=$product_data['id']?>" class="left product_related">
	...
	<div class="product_related_caption">
		<div class="thumb_product_title"><?= $product_data['title'] ?></div>
		<div class="thumb_product_price">&euro;<?= number_format($product_data['price'], 2) ?></div>
	</div>
</div>
