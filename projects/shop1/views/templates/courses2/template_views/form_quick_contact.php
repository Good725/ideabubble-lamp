        ...
        <fieldset>
            <ul>
                ...
                <li>
                    ...
                    <input type="text" id="contact_form_tel" name="contact_form_tel" value="<?= isset($_GET['course_id']) ? 'Course enquiry' : '' ?>" />
                </li>
                <li>
                ...
                <li>
					<?php $message =  (isset($_GET['course_id']) AND trim($_GET['course_id'])) ? 'I would like to enquire about course '.$_GET['course_id'].': &quot;'.Model_Courses::get_course_name($_GET['course_id']).'&quot;.'."\n" : ''; ?>
                    <label for="contact_form_message">Message</label>
                    <textarea cols="20" class="messagearea" rows="6" id="contact_form_message"
                              name="contact_form_message"><?= $message ?></textarea>
                </li>
