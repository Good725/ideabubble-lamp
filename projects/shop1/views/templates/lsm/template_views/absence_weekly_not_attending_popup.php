  ...
  <div class="screenTable">
    <div class="screenCell">
      <div class="sectioninner">
        	<div class="popup-title">Will attend weekly
		        	...
		        	<div class="one-half-view">
		        		<div class="colm">
		        			...
		        			<div class="form-wrap">
		        				...
		        				<label class="icon-wrap">
		        					<input type="text"  value="10:00pm">
		        					<i class="fa fa-clock-o" aria-hidden="true"></i>
		        				</label>
		        			</div>
		        			<div class="colm">
		        				<label class="form-label">Days in Week</label>
		        				<ul class="week-name">
		        					<li><input type="checkbox"  /> <a href="#">S</a></li>
		        					<li><input type="checkbox"  /><a href="#">M</a></li>
		        					<li><input type="checkbox"  /><a href="#">T</a></li>
		        					<li><input type="checkbox"  checked/><a href="#">W</a></li>
		        					<li><input type="checkbox"  checked/><a href="#">T</a></li>
		        					<li><input type="checkbox" /><a href="#">F</a></li>
		        					<li><input type="checkbox" /><a href="#">S</a></li>
		        				</ul>
			        		</div>
			        		<div class="colm">
