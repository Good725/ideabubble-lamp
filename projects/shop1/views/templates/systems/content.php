<?php $sidebar_modules = (isset($sidebar_modules)) ? $sidebar_modules : array('products', 'panels'); ?>
			...
			<div id="main" class="main">
				...
				<div id="ct" class="ct">
					...
					<div class="content">
						...
						<div class="successful message_area"><?php // tags are back-to-back to avoid excessive spacing
							if ( ! is_null($alerts)): ?>
						...
						if (isset($_GET['pname']) AND trim($_GET['pname']))
						{
							if (isset($_GET['pid']) AND trim($_GET['pid']))
							{
								$preload_message = 'I am interested in hearing more about Product #'.$_GET['pid'].': &quot;'.$_GET['pname']."&quot;.\n\n";
							}
							else
							{
								$preload_message = 'I am interested in hearing more about &quot;'.$_GET['pname']."&quot;.\n\n";
							}
						...
						{
							include 'template_views/order_history_table.php';
						}
