					...
					if (limit === 0 || limit > i) {
						...
						if ((month === false || month == eventMonth)
								...
								if (month === false && eventDate < new Date()) {
									...
									events_temp[i]['li'] = ('<li id="' + key + '" class="'+event.type+'"><time datetime="'+eventDate+'"><em> • ' + eventStringDate + '</em><small>'+eventHour+":"+eventMinute+'</small></time>'+eventTitle+'<p class="eventDesc ' + eventDescClass + '"> </p></li>');
									i++;
								}
						}
					}
